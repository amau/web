...
/*
		$("a[rel='lightbox']").colorbox({current:"{current}/{total}", width:500, height:500,});
*/
/* 		$('a[rel="lightbox_'+parentId+'"]').colorbox({current:"{current}/{total}", width:500, height:500, iframe:true});
 */

		$("a[rel='lightbox']").colorbox({current:"{current}/{total}", iframe:true, innerWidth:640, innerHeight:480});
